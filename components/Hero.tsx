        ...
        <div className="py-8 border-b border-blue-500/10">
          <div className="pb-5 md:flex items-center justify-between">
            <div>
              ...
              <p className="md:text-lg text-md text-snow/40 tracking-wide">
                Mfoniso Johnson
              </p>
            </div>
          ...
          <div className="flex border-t border-blue-500 pt-4 mt-4">
            {/* Team breakdown */}
              ...
              {[
                ...
                <div key={t.name} className="flex items-center gap-2">
                  <a className="hover:underline leading-8" href="">
                    <span className="text-sm text-snow/35">{t.name}&nbsp;</span>
                    <span className="text-sm font-semibold text-snow/55">
                      ({t.pts})
                    </span>
                  </a>
                </div>
