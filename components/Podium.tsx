...
export default function Podium() {
  return (
    <div>
      <p className="text-lg font-bold tracking-[0.2em] uppercase text-snow/30">
        League Leaders
      </p>
      <p className="pb-4 pt-2 text-sm text-gray-400">Our top 3 at the moment</p>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3 bg-blue-500 rounded-xl px-4 py-4 hover:scale-105 transition-all ease-in-out duration-300">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-lg font-bold text-white leading-tight tracking-wider truncate">{leaders[0].team}</p>
